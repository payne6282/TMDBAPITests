...
public class SearchMoviesAPI {
	...
	/* These tests are to check how the API handles different data being passed in the search query. Example - Correct query, wrong one, null etc */
	...
	//Search query with space to check how space between queries are handled.Expected should be 200 OK.
	@Test
	...
	@Test
	public void T12_OnlySpaceInQuerySearch() {
		String searchQuery = " "; 
		RestUtils.createSearchQueryPathSearchMovieAPI(Constants.API_KEY_PARAM, Constants.API_KEY_VALUE, "language", "en-US", "query", searchQuery, "page", "1" );	
		responsePathSetUp();
		HelperMethods.checkStatus200(res);
